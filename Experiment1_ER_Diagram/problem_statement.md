...
### ER Diagram:
<img width="1215" height="819" alt="image" src="https://github.com/user-attachments/assets/692dba9a-6b6c-4c3b-8b90-302e497fe4a8" />
...
### ER Diagram:
<img width="1614" height="975" alt="image" src="https://github.com/user-attachments/assets/c53b24d3-376e-43dc-a6e3-392cc7c4365d" />
...
3.A fine is generated only for overdue loans.
4.Each event is conducted in one room.
...
### ER Diagram:
<img width="1522" height="712" alt="reservedbms drawio" src="https://github.com/user-attachments/assets/db5a31e6-0c13-41b1-88ff-2741532535a4" />
...
| Relationship               | Cardinality                                          | Participation | Notes                                   |
| -------------------------- | ---------------------------------------------------- | ------------- | --------------------------------------- |
| Customer makes Reservation | **1:M**                                              | Total         | One customer can make many reservations |
| Waiter serves Reservation  | **1:M**                                              | Total         | One waiter serves many reservations     |
| Reservation has Order      | **1:1**                                              | Total         | One reservation has one order           |
| Order contains Order Item  | **1:M**                                              | Total         | One order contains many order items     |
| Order Item includes Dish   | **M:N**                                              | Total         | Ordered dishes                          |
| Category classifies Dish   | **1:M**                                              | Total         | One category has many dishes            |
| Reservation generates Bill | **1:1**                                              | Total         | One reservation generates one bill      |


### Assumptions
1.Each customer has a unique customer_id.
2.A customer can make multiple reservations.
3.Every reservation is served by one waiter.
4.Each reservation generates one bill.
5.A dish belongs to one category.
6.An order can contain multiple order items.
